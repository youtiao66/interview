...
!(function(e, t) {
  ...
  var p = (function(n) {
    ...
    try {
      H.apply((t = q.call(b.childNodes)), b.childNodes), t[b.childNodes.length].nodeType
    } catch (e) {
      H = {
        apply: t.length
          ? function(e, t) {
          ...
          if (((c = t), (f = e), 1 === d && (Q.test(t) || X.test(t)))) {
            for (
              ((f = (ne.test(t) && ve(e.parentNode)) || e) === e && p.scope) ||
                ((s = e.getAttribute('id')) ? (s = s.replace(ie, oe)) : e.setAttribute('id', (s = S))),
                o = (l = h(t)).length;
              o--;
    ...
    (se.matchesSelector = function(e, t) {
      if ((C(e), p.matchesSelector && E && !I[t + ' '] && (!c || !c.test(t)) && (!g || !g.test(t))))
        try {
          var n = v.call(e, t)
                  ...
                  if (((u = [y ? c.firstChild : c.lastChild]), y && d)) {
                    ...
                    for (
                      ...
                      ((b ? a.nodeName.toLowerCase() !== f : 1 !== a.nodeType) ||
                        !++p ||
                        (d && ((i = (o = a[S] || (a[S] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [k, p]),
                        a !== e));
      ...
      for (
        ...
        if ((t = x.relative[e[s].type])) c = [xe(we(c), t)]
          ...
          if ((t = x.filter[e[s].type].apply(null, e[s].matches))[S]) {
            ...
            return Te(
              1 < s && we(c),
              1 < s && be(e.slice(0, s - 1).concat({ value: ' ' === e[s - 2].type ? '*' : '' })).replace(W, '$1'),
              t,
              s < n && Ee(e.slice(s, n)),
              n < r && Ee((e = e.slice(n))),
              n < r && be(e)
    ...
    return (
      ...
      (h = se.tokenize = function(e, t) {
        ...
        for (a = e, s = [], u = x.preFilter; a; ) {
          ...
          (n = !1),
          (r = X.exec(a)) &&
            ((n = r.shift()), i.push({ value: n, type: r[0].replace(W, ' ') }), (a = a.slice(n.length))),
          x.filter))
            !(r = G[o].exec(a)) ||
              (u[o] && !(r = u[o](r))) ||
      ...
      (m = se.select = function(e, t, n, r) {
        ...
        if (((n = n || []), 1 === c.length)) {
          ...
          for (i = G.needsContext.test(e) ? 0 : o.length; i-- && ((a = o[i]), !x.relative[(s = a.type)]); )
            if (
              (u = x.find[s]) &&
              (r = u(a.matches[0].replace(re, f), (ne.test(o[0].type) && ve(t.parentNode)) || t))
            ) {
      ...
      function(r, i) {
        S.fn[r] = function(e, t) {
          ...
          return (
            ...
            1 < this.length && (O[r] || S.uniqueSort(n), D.test(r) && n.reverse()),
            this.pushStack(n)
          )
        }
      }
    ...
    S.extend({
                      ...
                      ;(t = e && ('object' == typeof e || 'function' == typeof e) && e.then),
                        b(t)
                          ? s
                            ...
                            : (u++, t.call(e, l(u, o, q, s), l(u, o, M, s), l(u, o, q, o.notifyWith)))
                          : (a !== q && ((n = void 0), (r = [e])), (s || o.resolveWith)(n, r))
                    }
                  }
                  var n = this,
                    r = arguments,
      ...
      when: function(e) {
        ...
        var n = arguments.length,
          ...
          o = s.call(arguments),
          a = S.Deferred()
        if (n <= 1 && (_(e, a.done(t(r)).resolve, a.reject, !n), 'pending' === a.state() || b(o[r] && o[r].then)))
          return a.then()
  ...
  ;(S.fn.ready = function(e) {
    ...
    'complete' === E.readyState || ('loading' !== E.readyState && !E.documentElement.doScroll)
      ...
      : (E.addEventListener('DOMContentLoaded', B), T.addEventListener('load', B))
    ...
    S.fn.extend({
      data: function(n, e) {
        ...
        if (void 0 !== n)
          return 'object' == typeof n
            ...
            : F(
                ...
                function(e) {
                  var t
                  if (o && void 0 === e) return void 0 !== (t = G.get(o, n)) || void 0 !== (t = J(o, n)) ? t : void 0
                  this.each(function() {
                    G.set(this, n, e)
                  })
                },
        ...
        if (this.length && ((i = G.get(o)), 1 === o.nodeType && !V.get(o, 'hasDataAttrs'))) {
          for (t = a.length; t--; )
            a[t] && 0 === (r = a[t].name).indexOf('data-') && ((r = X(r.slice(5))), J(o, r, i[r]))
      ...
      queue: function(e, t, n) {
        ...
        if (e)
          return (
            (t = (t || 'fx') + 'queue'),
            (r = V.get(e, t)),
            n && (!r || Array.isArray(n) ? (r = V.access(e, t, S.makeArray(n))) : r.push(n)),
            r || []
          )
      },
    ...
    S.fn.extend({
      ...
      promise: function(e, t) {
        ...
        for ('string' != typeof e && ((t = e), (e = void 0)), e = e || 'fx'; s--; )
          (r = V.get(a[s], e + 'queueHooks')) && r.empty && (i++, r.empty.add(n))
  ...
  function le(e, t) {
    for (var n, r, i, o, a, s, u, l = [], c = 0, f = e.length; c < f; c++)
      (r = e[c]).style &&
        ((n = r.style.display),
        t
          ? ('none' === n && ((l[c] = V.get(r, 'display') || null), l[c] || (r.style.display = '')),
            '' === r.style.display &&
              ae(r) &&
              (l[c] =
                ((u = a = o = void 0),
        ...
        S.event.add(e, i, {
          ...
          handler: function(e) {
            ...
            if (1 & e.isTrigger && this[i]) {
              ...
              r.length &&
                (V.set(this, i, { value: S.event.trigger(S.extend(r[0], S.Event.prototype), r.slice(1), this) }),
  ...
  ;(S.event = {
      ...
      if (g && (u = g.events)) {
        for (l = (t = (t || '').match(H) || ['']).length; l--; )
          if (((p = m = (s = Ce.exec(t[l]) || [])[1]), (h = (s[2] || '').split('.').sort()), p)) {
            ...
            a &&
              !d.length &&
              ((f.teardown && !1 !== f.teardown.call(e, h, g.handle)) || S.removeEvent(e, p, g.handle), delete u[p])
    ...
    special: {
      ...
      click: {
        setup: function(e) {
          var t = this || e
          return de.test(t.type) && t.click && A(t, 'input') && Ae(t, 'click', Te), !1
        },
        trigger: function(e) {
          var t = this || e
        ...
        _default: function(e) {
          var t = e.target
          return (de.test(t.type) && t.click && A(t, 'input') && V.get(t, 'click')) || A(t, 'a')
        }
      },
      beforeunload: {
      ...
      e && e.type
        ? ((this.originalEvent = e),
          ...
          (this.isDefaultPrevented =
            e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? Te : Ee),
  ...
  function Pe(e, t) {
    ...
    if (1 === t.nodeType) {
      if (V.hasData(e) && (s = V.get(e).events))
        for (i in (V.remove(t, 'handle events'), s)) for (n = 0, r = s[i].length; n < r; n++) S.event.add(t, i, s[i][n])
  ...
  function He(n, r, i, o) {
    ...
    if (
      f &&
      ((t = (e = be(r, n[0].ownerDocument, !1, n, o)).firstChild), 1 === e.childNodes.length && (e = t), t || o)
    ) {
      for (s = (a = S.map(ge(e, 'script'), De)).length; c < f; c++)
        (u = e), c !== d && ((u = S.clone(u, !0, !0)), s && S.merge(a, ge(u, 'script'))), i.call(n[c], u, c)
      if (s)
  ...
  S.extend({
    ...
    clone: function(e, t, n) {
      ...
      if (t)
        if (n) for (o = o || ge(e), a = a || ge(c), r = 0, i = o.length; r < i; r++) Pe(o[r], a[r])
        else Pe(e, c)
        ...
        set: function(e, t, n) {
          ...
          return (
            a &&
              o &&
              (s -= Math.ceil(
                e['offset' + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - ut(e, u, 'border', !1, i) - 0.5
              )),
    ...
    ((ct.propHooks = {
      _default: {
        ...
        set: function(e) {
          S.fx.step[e.prop]
            ? S.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType || (!S.cssHooks[e.prop] && null == e.elem.style[nt(e.prop)])
            ? (e.elem[e.prop] = e.now)
  ...
  function vt() {
    dt &&
      (!1 === E.hidden && T.requestAnimationFrame ? T.requestAnimationFrame(vt) : T.setTimeout(vt, S.fx.interval),
      S.fx.tick())
  }
  function yt() {
    return (
  ...
  function wt(o, e, t) {
    ...
    for (
      ...
      if ((n = wt.prefilters[r].call(l, o, c, l.opts)))
        return b(n.stop) && (S._queueHooks(l.elem, l.opts.queue).stop = n.stop.bind(n)), n
    return (
      S.map(c, xt, l),
  ...
  ;(S.Animation = S.extend(wt, {
    ...
    tweener: function(e, t) {
      for (var n, r = 0, i = (e = b(e) ? ((t = e), ['*']) : e.match(H)).length; r < i; r++)
    ...
    prefilters: [
      function(e, t, n) {
        ...
        if ((u = !S.isEmptyObject(t)) || !S.isEmptyObject(p))
          ...
          p))
            u ||
              (g ? 'hidden' in g && (m = g.hidden) : (g = V.access(e, 'fxshow', { display: l })),
              o && (g.hidden = !m),
              m && le([e], !0),
              d.done(function() {
                for (r in (m || le([e]), V.remove(e, 'fxshow'), p)) S.style(e, r, p[r])
              })),
              (u = xt(m ? g[r] : 0, r, d)),
          ...
          : this.each(function() {
              ...
              if (a)
                ...
                (void 0 !== i && 'boolean' != o) ||
                  ...
                  this.setAttribute &&
                    this.setAttribute('class', (!e && !1 !== i && V.get(this, '__className__')) || ''))
            })
      },
      hasClass: function(e) {
        var t,
          ...
          r = 0
        for (t = ' ' + e + ' '; (n = this[r++]); )
          if (1 === n.nodeType && -1 < (' ' + kt(At(n)) + ' ').indexOf(t)) return !0
        return !1
      }
    })
  var jt = /\r/g
  ...
  function $t(n, e, r, i) {
    ...
    if (Array.isArray(e))
      S.each(e, function(e, t) {
        r || Ht.test(n) ? i(n, t) : $t(n + '[' + ('object' == typeof t && null != t ? e : '') + ']', t, r, i)
      })
      ...
      ajax: function(e, t) {
        ...
        if (
          ...
          try {
            ;(r.href = g.url),
              (r.href = r.href),
              (g.crossDomain = Vt.protocol + '//' + Vt.host != r.protocol + '//' + r.host)
          } catch (e) {
            g.crossDomain = !0
          }
        }
        if (
          (g.data && g.processData && 'string' != typeof g.data && (g.data = S.param(g.data, g.traditional)),
          Kt(Xt, g, t, C),
          h)
        )
          return C
        for (i in ((m = S.event && g.global) && 0 == S.active++ && S.event.trigger('ajaxStart'),
        ...
        g.hasContent
          ...
          : ((o = g.url.slice(f.length)),
            ...
            !1 === g.cache && ((f = f.replace(Ft, '$1')), (o = (Pt.test(f) ? '&' : '?') + '_=' + Ot.guid++ + o)),
            (g.url = f + o)),
        g.ifModified &&
          (S.lastModified[f] && C.setRequestHeader('If-Modified-Since', S.lastModified[f]),
        ...
        C.setRequestHeader(
          ...
          g.dataTypes[0] && g.accepts[g.dataTypes[0]]
            ? g.accepts[g.dataTypes[0]] + ('*' !== g.dataTypes[0] ? ', ' + Yt + '; q=0.01' : '')
            : g.accepts['*']
        ),
        g.headers))
          C.setRequestHeader(i, g.headers[i])
        if (g.beforeSend && (!1 === g.beforeSend.call(v, C, g) || h)) return C.abort()
        if (((u = 'abort'), x.add(g.complete), C.done(g.success), C.fail(g.error), (c = Kt(Qt, g, t, C)))) {
        ...
        function l(e, t, n, r) {
          ...
          h ||
            ...
            !i && -1 < S.inArray('script', g.dataTypes) && (g.converters['text script'] = function() {}),
            (s = (function(e, t, n, r) {
              var i,
                o,
                a,
            ...
            i
              ? (g.ifModified &&
                  ((u = C.getResponseHeader('Last-Modified')) && (S.lastModified[f] = u),
  ...
  S.ajaxSetup({
      ...
      if (a || 'jsonp' === e.dataTypes[0])
        return (
          ...
          a
            ...
            : !1 !== e.jsonp && (e.url += (Pt.test(e.url) ? '&' : '?') + e.jsonp + '=' + r),
    ...
    (y.createHTMLDocument =
      (((tn = E.implementation.createHTMLDocument('').body).innerHTML = '<form></form><form></form>'),
    ...
    (S.parseHTML = function(e, t, n) {
      return 'string' != typeof e
        ...
        : ('boolean' == typeof t && ((n = t), (t = !1)),
          ...
          (i = N.exec(e))
            ? [t.createElement(i[1])]
            : ((i = be([e], t, o)), o && o.length && S(o).remove(), S.merge([], i.childNodes)))
      var r, i, o
    }),
    ...
    function d() {
      ...
      ;(i = r = 0),
        ...
        s.children().each(function() {
          var e, t
          ;(e = $(this)), (t = e.clone()).css('visibility', 'hidden'), a.append(t), n(0, t.outerWidth()), t.remove()
        })
    }
    d()
    var p,
  ...
  (function(e) {
    ...
    function h(e) {
      return (
        (e === t && m.currTemplate.closeBtn) ||
          ((m.currTemplate.closeBtn = c(m.st.closeMarkup.replace('%title%', m.st.tClose))), (t = e)),
    ...
    ;(e.prototype = {
      ...
      open: function(e) {
        ...
        if (!m.isOpen) {
          ;(m.types = []),
            ...
            e.key
              ? (m.popupsCache[e.key] || (m.popupsCache[e.key] = {}), (m.currTemplate = m.popupsCache[e.key]))
              : (m.currTemplate = {}),
          ...
          return (
            ...
            setTimeout(function() {
              m.content ? (m._addClassToMFP(w), m._setFocus()) : m.bgOverlay.addClass(w),
      ...
      _openClick: function(e, t, n) {
        if (
          (void 0 !== n.midClick ? n.midClick : c.magnificPopup.defaults.midClick) ||
      ...
      (c.fn.magnificPopup = function(e) {
        ...
        if ('string' == typeof e)
          if ('open' === e) {
            ...
            ;(n = r.items ? r.items[i] : ((n = t), r.delegate && (n = n.find(r.delegate)), n.eq(i))),
      ...
      proto: {
        ...
        resizeImage: function() {
          ...
          if (e && e.img && m.st.image.verticalFit) {
            var t = 0
            m.isLowIE && (t = parseInt(e.img.css('padding-top'), 10) + parseInt(e.img.css('padding-bottom'), 10)),
        ...
        _onImageHasSize: function(e) {
          e.img &&
            ...
            p('ImageHasSize', e),
            e.imgHidden && (m.content && m.content.removeClass('mfp-loading'), (e.imgHidden = !1)))
        },
            ...
            i = function(e) {
              D && clearInterval(D),
                (D = setInterval(function() {
                  0 < r.naturalWidth
                    ? m._onImageHasSize(t)
                    : (200 < n && clearInterval(D), 3 === ++n ? i(10) : 40 === n ? i(50) : 100 === n && i(500))
                }, e))
            }
          i(1)
        },
        getImage: function(e, t) {
          var n = 0,
            ...
            i = function() {
              e &&
                (e.img.off('.mfploader'),
                e === m.currItem && (m._onImageHasSize(e), m.updateStatus('error', o.tError.replace('%url%', e.src))),
                (e.hasSize = !0),
                (e.loaded = !0),
                (e.loadError = !0))
            },
          ...
          return (
            ...
            e.hasSize
              ? (D && clearInterval(D),
                e.loadError
                  ? (t.addClass('mfp-loading'), m.updateStatus('error', o.tError.replace('%url%', e.src)))
    ...
    c.magnificPopup.registerModule('zoom', {
      ...
      proto: {
        ...
        _getOffset: function(e) {
          ...
          var o = { width: t.width(), height: (s ? t.innerHeight() : t[0].offsetHeight) - i - r }
          return (
  ...
  (function(e, t) {
    ...
    function L(e, t, n, r) {
      if (t.emitEvents && 'function' == typeof A.CustomEvent) {
        var i = new CustomEvent(e, { bubbles: !0, detail: { anchor: n, toggle: r } })
    ...
    return function(r, e) {
          ...
          if (l || t) {
            ...
            var n,
              ...
              g = l
                ...
                : (function(e, t, n, r) {
                    var i = 0
                    if (e.offsetParent) for (; (i += e.offsetTop), (e = e.offsetParent); );
                    return (i = Math.max(i - t - n, 0)), r && (i = Math.min(i, j() - A.innerHeight)), i
                  })(t, m, parseInt('function' == typeof u.offset ? u.offset(a, s) : u.offset, 10), u.clip),
              v = g - c,
              y = j(),
              b = 0,
              x =
                ((n = v),
                (i = (r = u).speedAsDuration ? r.speed : Math.abs((n / 1e3) * r.speed)),
            ...
            0 === A.pageYOffset && A.scrollTo(0, 0),
              ...
              'matchMedia' in A && A.matchMedia('(prefers-reduced-motion)').matches
                ...
                : (L('scrollStart', u, a, s), k.cancelScroll(!0), A.requestAnimationFrame(C))
          }
        })
      function t(e) {
        if (
              ...
              if (history.replaceState && e.updateURL && !history.state) {
                ...
                ;(t = t || ''),
                  history.replaceState(
                    { smoothScroll: JSON.stringify(e), anchor: t || A.pageYOffset },
                    document.title,
                    t || A.location.href
                  )
              }
      ...
      function n(e) {
        if (null !== history.state && history.state.smoothScroll && history.state.smoothScroll === JSON.stringify(T)) {
          var t = history.state.anchor
          ;('string' == typeof t && t && !(t = document.querySelector(o(history.state.anchor)))) ||
      ...
      return (
        (function() {
          ...
          k.destroy(),
            ...
            T.updateURL && T.popstate && A.addEventListener('popstate', n, !1)
        })(),
        k
      )
    }
  ...
  (function(e, t) {
    ...
    function a(e, t, n) {
      ...
      return n
        ? parseInt(i.bottom, 10) < (c.innerHeight || document.documentElement.clientHeight)
        : parseInt(i.top, 10) <= o
    }
    function s() {
      return (
